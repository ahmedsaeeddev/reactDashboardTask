...
const profiles = [
  ...
  },
  {
    ...
    background:
      "https://images.pexels.com/photos/1640794/pexels-photo-1640794.jpeg",
    profileImage:
  ...
  },
  {
    ...
    description:
      "Innovative digital marketer with a knack for social media strategies.",
    background:
  ...
  },
  {
    ...
    description:
      "Passionate content writer creating engaging and informative articles.",
    background:
  ...
  },
  {
    ...
    description:
      "Enthusiastic mobile app developer with experience in cross-platform apps.",
    background:
